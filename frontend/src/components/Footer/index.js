    ...
    return (
        <footer>
            <div className="footer-links">
                ...
                <li><a href="https://github.com/NygilNet/aa-capstone-project" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-book-bookmark fa-2x" style={{color: "#CCCCCC"}} ></i></a></li>
                </ul>
            </div>
